...
def main() -> int:
    ...
    prompt += (
        ...
        "Qualification checkpoint: after the first screen-correct candidate "
        "meeting minimum_material_speedup, run and persist its held-out check "
        "before starting any later candidate. Keep a passing candidate as the "
        "delivery baseline until another candidate also passes held-out.\n"

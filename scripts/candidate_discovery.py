...
def parse_args() -> argparse.Namespace:
    ...
    init.add_argument("--min-candidates", type=int, default=2)
    init.add_argument("--max-candidates", type=int, default=6)
    init.add_argument("--min-families", type=int, default=2)

...
def parse_args() -> argparse.Namespace:
    ...
    init.add_argument("--min-opportunities", type=int, default=2)
    init.add_argument("--max-opportunities", type=int, default=6)
    init.add_argument("--min-rewrite-families", type=int, default=2)
    init.add_argument("--min-candidate-opportunities", type=int, default=1)

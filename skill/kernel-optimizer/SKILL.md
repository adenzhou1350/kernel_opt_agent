...
8. Build and freeze 2--4 architecture-level schedule candidates.  Compute each
   ...
   ceiling instead of guessing it, and stop candidates with a proven-unreachable
   production path, a ceiling below the materiality floor, or unjustified
   permanent review/API/protocol cost.

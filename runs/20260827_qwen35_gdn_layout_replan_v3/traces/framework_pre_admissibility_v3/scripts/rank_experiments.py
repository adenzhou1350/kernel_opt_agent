...
from supervision_utils import artifact_path, validate_decision_contract
    ...
    if queue.get("schema_version") == "experiment-request-queue-v2":
        ...
        for request in queue.get("requests", []):
            ...
            request["sensitivity"].update({
                "candidate_specific_decision_value_us": value,
                ...
                "ranking_score": score,
                "benefit_derivation": {
                    "method": "top-two candidate ordering sensitivity from the frozen decision contract",
        ...
        queue["ranking_policy"] = {
            ...
            "benefit_bound": "frozen top-two candidate decision contract",
            "ranked_at": ranked_at,
        }
